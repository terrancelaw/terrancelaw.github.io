const StochasticView = {
	...
	init: function() {
		...
		let chartWidth = $('#stochastic > .vis-container > .chart > svg').width();
		let chartHeight = $('#stochastic > .vis-container > .chart > svg').height();
    	...
    	let svgGroup = d3.select('#stochastic > .vis-container > .chart > svg').append('g')
	...
	adjustText: function() {
		...
		d3.select(tr_e_text[0]).attr('dx', 10).attr('dy', 1);
		d3.select(tr_e_text[1]).attr('dx', 5).attr('dy', 10);
		d3.select(tr_e_text[2]).attr('dx', 5).attr('dy', 10);
		d3.select(tr_e_text[3]).attr('dx', 5).attr('dy', 10);
		d3.select(tr_e_text[4]).attr('dx', 0).attr('dy', -7);
		d3.select(tr_e_text[5]).attr('dx', 2).attr('dy', -7);

		d3.select(te_e_text[0]).attr('dx', 5).attr('dy', 10);
		d3.select(te_e_text[1]).attr('dx', 0).attr('dy', -10);
		d3.select(te_e_text[2]).attr('dx', 5).attr('dy', 10);
		d3.select(te_e_text[3]).attr('dx', 5).attr('dy', 10);
		d3.select(te_e_text[4]).attr('dx', 5).attr('dy', 10);
		d3.select(te_e_text[5]).attr('dx', 5).attr('dy', 10);

		d3.select(adv_e_text[0]).attr('dx', 5).attr('dy', 10);
		...
		d3.select(adv_e_text[5]).attr('dx', 5).attr('dy', 10);
	},
	drawLegend: function() {
		const self = this;
		let svgGroup = self.svgGroup;
