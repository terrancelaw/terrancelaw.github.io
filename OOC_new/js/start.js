...
// add together = 660 + 5
var conceptMapViewHeight = 660 + margin;
...
$(function() {
	...
	$("#concept-map-view")
		.css("width", rightContentWidth)
		.css("height", conceptMapViewHeight);
	...
	d3.select("#concept-map-view svg")
		.attr("width", rightContentWidth)
		.attr("height", conceptMapViewHeight);
