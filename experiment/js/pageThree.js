var PageThree = {
	...
	drawLeftDescription: function() {
		...
		d3.select(".pair-a").append("text")
			...
			.text("Group 1's height ranges from 4'5'' to 5'1'' with a mean of 4'9''.");
		d3.select(".pair-a").append("text")
			.attr("x", 0)
			.attr("y", 250)
			.style("font-style", "italic")
			.style("font-size", 20)
			.text("Group 2's height ranges from 5'5'' to 6' with a mean of 5'9''.");
	},
	...
	drawLeftGroup1DotPlot: function() {
		var self = this;
		var width = 300;
		var xTranslate = 90, yTranslate = 560;
		var data = Database.trainingNumericalWideNoOverlap;
		...
		// draw dot plot
		d3.select(".pair-a").selectAll(".dot1")
			.data(data)
			.enter()
			.append("circle")
			.attr("class", "dot1")
	...
	drawLeftGroup2DotPlot: function() {
		var self = this;
		var width = 300;
		var xTranslate = 90, yTranslate = 620;
		var data = Database.trainingNumericalWideNoOverlap;
		...
		// draw dot plot
		d3.select(".pair-a").selectAll(".dot2")
			.data(data)
			.enter()
			.append("circle")
			.attr("class", "dot2")
